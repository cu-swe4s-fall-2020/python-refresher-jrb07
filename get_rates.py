...
def get_rates(state):
    ...
    result = my_utils.get_columns(case_file, query_column, query_value, result_columns,0)
    co_cases = []
    for r in result:
    ...
    result = my_utils.get_columns(population_file, query_column, query_value, result_columns)
    co_pops = []
    for r in result:
